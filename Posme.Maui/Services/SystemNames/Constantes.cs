...
public static class Constantes
{
    ...
    public static string UrlRequestLogin = UrlBase + "{CompanyKey}/core_acount/loginMobile";
    public static string UrlRequestDownload = UrlBase + "{CompanyKey}/app_mobile_api/getDataDownload";
    public static string UrlUpload = UrlBase + "{CompanyKey}/app_mobile_api/setDataUpload";
